    ...
    public partial class First : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductPromotion", x => new { x.ProductID, x.PromotionsPromotionID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrdresOrderID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductsProductID = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderProduct", x => new { x.OrdresOrderID, x.ProductsProductID });
                    table.ForeignKey(
                        name: "FK_OrderProduct_Orders_OrdresOrderID",
                        column: x => x.OrdresOrderID,
